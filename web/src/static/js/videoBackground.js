 ...
 */
export function initBgVideo(videoEl, options) {
    var _a;
    if (!videoEl)
        return;
    const opts = options !== null && options !== void 0 ? options : {};
    const fadeEl = (_a = opts.fadeEl) !== null && _a !== void 0 ? _a : null; // フェードオーバーレイ（なければ null）
    ...
    videoEl.addEventListener('timeupdate', () => {
        ...
        if (!videoEl.duration || fading || !fadeEl)
            return;
    ...
    if (p !== undefined) {
        p.then(() => { var _a; return (_a = opts.onSuccess) === null || _a === void 0 ? void 0 : _a.call(opts); }).catch(() => { var _a; return (_a = opts.onFail) === null || _a === void 0 ? void 0 : _a.call(opts); });
    }
}
